...
library(anndataR)
adata1 <- anndataR::read_h5ad("~/Downloads/HackathonFoundationExData/crop_spatial.h5ad")
adata1
spe <- as_SpatialExperiment(adata1)
spe
library(SpatialExperiment)
spatialCoords(spe)
spe <- addImg(spe,
    sample_id = "sample01",
    image_id = "cropped",
    imageSource = "~/Downloads/HackathonFoundationExData/crop_he_2500x2500.tif",
