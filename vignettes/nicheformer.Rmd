...
```{r annDataR_creation}
spe <- readRDS("/workspaces/project/data/CosMx1k_MouseBrain1_100tx_100cl.rds") 
...
adata$write_h5ad("/workspaces/project/data/spe_converted.h5ad", mode = "w")
nicheformer_data <- Run_nicheformer(adata_path = "/workspaces/project/data/spe_converted.h5ad",
                                  technology = "cosmx")
```
